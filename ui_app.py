...
.btn-start button,
.btn-start button.gr-button,
.btn-start button.gr-button-primary {
    background: #1B4E8E !important;
...
.btn-start button.gr-button:hover,
.btn-start button.gr-button-primary:hover {
    background: #215ea8 !important;
    background-color: #215ea8 !important;
}

.btn-stop button,
.btn-stop button.gr-button,
.btn-stop button.gr-button-secondary,
.btn-stop button.gr-button-primary {
    background: #254B73 !important;
...
.btn-stop button.gr-button:hover,
.btn-stop button.gr-button-secondary:hover,
.btn-stop button.gr-button-primary:hover {
    background: #2e5f8f !important;
    background-color: #2e5f8f !important;
}

.btn-hardstop button,
.btn-hardstop button.gr-button,
.btn-hardstop button.gr-button-secondary {
...
.btn-hardstop button.gr-button:hover,
.btn-hardstop button.gr-button-secondary:hover {
    background: #284876 !important;
    background-color: #284876 !important;
}

.btn-apply button,
.btn-apply button.gr-button,
.btn-apply button.gr-button-secondary,
.btn-apply button.gr-button-primary {
...
.btn-apply button.gr-button:hover,
.btn-apply button.gr-button-secondary:hover,
.btn-apply button.gr-button-primary:hover {
    background: #5c81b6 !important;
    background-color: #5c81b6 !important;
}

.btn-restart button,
.btn-restart button.gr-button,
.btn-restart button.gr-button-secondary {
    background: #4A6FA5 !important;
    background-color: #4A6FA5 !important;
    background-image: none !important;
    color: #ffffff !important;
...
.btn-restart button.gr-button:hover,
.btn-restart button.gr-button-secondary:hover {
    background: #5c81b6 !important;
    background-color: #5c81b6 !important;
}
